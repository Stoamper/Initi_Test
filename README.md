...
- [Описание процесса работы адаптивных алгоритмов](#alg_desc)
...
Каждый из этих вариантов со своими особенностями более подробно описывается в следующем подразделе.
...
**ссылку на циклограммы**



## <a name="alg_desc"></a> Описание процесса работы адаптивных алгоритмов
...
**картинки с последовательностью работы светофоров**
